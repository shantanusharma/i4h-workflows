...
class G1LocomanipPushCartEnvironment(ExampleEnvironmentBase):
    name: str = "g1_locomanip_push_cart"
    ...
    def get_env(self, args_cli: argparse.Namespace):
        ...
        destination_cart = self.asset_registry.get_asset_by_name(args_cli.object)()
        ...
        isaaclab_arena_environment = IsaacLabArenaEnvironment(
            ...
            scene=scene,
            task=G1PushCartTask(pick_up_object, destination_cart, background, episode_length_s=40.0),
